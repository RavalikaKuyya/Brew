...
class GravityDelegate(
    ...
    private var snapLastItem: Boolean = enableSnapLast
    ...
    private fun isRtl(): Boolean = TextUtils.getLayoutDirectionFromLocale(Locale.getDefault()) == View.LAYOUT_DIRECTION_RTL
